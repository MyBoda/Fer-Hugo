document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. LÓGICA DEL CONTADOR (02 de Enero de 2027)
    ...
    if (openEnvelopeBtn && overlay) {
        openEnvelopeBtn.addEventListener('click', () => {
            ...
            // Forzar que los elementos visibles en el inicio aparezcan
            setTimeout(() => {
                document.querySelectorAll('.hero-content.fade-in, .hero.fade-in').forEach(el => el.classList.add('visible'));
            }, 150);
